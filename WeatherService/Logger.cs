...
namespace WeatherService
{
    class Logger
    {
        ...
        public void MessageWeather(string msg)
        {
            string path = AppDomain.CurrentDomain.BaseDirectory.ToString() + "\\Weatherlog";
            string todayDate = DateTime.Now.ToString("yyyyMMdd");
            ...
            {
                myStream.WriteLine($"[{DateTime.Now}]");
                myStream.WriteLine("There is no connection with weather service");
            }
